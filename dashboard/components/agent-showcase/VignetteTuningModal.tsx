        ...
        <AnimatePresence>
            {isOpen && (
                <motion.div 
                    ...
                    className="fixed top-1/2 left-1/2 z-[9999] pointer-events-auto w-[400px] nerv-glass-3 bg-black/90 p-6 rounded-xl border border-[#FF6D29]/50 shadow-[0_0_30px_rgba(255,40,0,0.2)] text-white font-mono"
