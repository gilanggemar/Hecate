    ...
    return (
        <div
            ...
            style={{
                ...
                border: isEmpty ? '1px dashed var(--nerv-border-subtle)' : '1px solid rgba(234, 120, 47, 0.2)',
            }}
        >
            {/* ─── Goal Summary Button ─── */}
            {goals.length > 0 && (
                <div className="relative shrink-0">
                    <button
                        ...
                        style={{
                            background: 'color-mix(in srgb, var(--nerv-cyan) 12%, transparent)',
                            border: '1px solid color-mix(in srgb, var(--nerv-cyan) 25%, transparent)',
                            color: 'var(--nerv-cyan)',
                        }}
                    >
                    ...
                    {showGoalDropup && (
                        ...
                        >
                            <div className="p-2.5 space-y-1">
                                <span className="text-[10px] font-semibold uppercase tracking-wider block mb-1.5" style={{ color: 'var(--nerv-text-tertiary)' }}>
                                    Active Goals
                                </span>
                                {goals.map(g => (
                                    <div
                                        ...
                                        style={{ color: 'var(--foreground)' }}
                                    >
                                        <Target className="w-3 h-3 shrink-0" style={{ color: 'var(--nerv-cyan)' }} />
            ...
            {constraints.length > 0 && (
                <div className="relative shrink-0">
                    <button
                        ...
                        className="flex items-center gap-1.5 px-2.5 py-1 rounded-md text-[10px] font-semibold tracking-wide uppercase transition-all duration-200 hover:brightness-125"
                        style={{
                            background: 'color-mix(in srgb, var(--nerv-danger) 12%, transparent)',
                            border: '1px solid color-mix(in srgb, var(--nerv-danger) 25%, transparent)',
                            ...
                            <div className="p-2.5 space-y-1">
                                ...
                                {constraints.map(c => (
                                    <div
                                        ...
                                        style={{ color: 'var(--foreground)' }}
                                    >
                                        <Shield className="w-3 h-3 shrink-0" style={{ color: 'var(--nerv-danger)' }} />
