                    ...
                    <div className={cn("flex flex-col gap-1 w-full max-w-[250px] font-sans group", className)}>
                        ...
                        <div className="flex items-center justify-between">
                            <div className="flex items-center gap-1.5 flex-1 min-w-0">
                                ...
                                <span
                                    className={cn("nerv-badge-text truncate", isArchitect && "relative overflow-hidden")}
                                ...
                                <div className="flex items-center gap-0.5 ml-1 shrink-0">
                                    <span className="nerv-metric-sm text-foreground/80">Lv.{level}</span>
                                    {hasPrecisionBonus && (
                                        <motion.span
                            ...
                            <span className="nerv-caption opacity-70 tabular-nums shrink-0 ml-2">
                                {Math.floor(progress)}%
                            </span>
                        </div>
                        ...
                        <div className="text-right">
                            <span className="nerv-caption opacity-50 tabular-nums">
