    ...
    return (
        <TooltipProvider>
            <div className="hecate-app-shell">
                <TopRightUserMenu />
                <ShellFrame>
                    <main className={`hecate-content-viewport${pathname === '/dashboard/constellation' || pathname === '/dashboard/scheduler' || pathname?.match(/^\/dashboard\/workflows\/[^/]+\/builder/) ? ' hecate-content-fullbleed' : ''}`}>
                        <ClientShell>
                            <Suspense fallback={
