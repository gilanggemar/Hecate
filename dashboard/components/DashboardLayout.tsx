    ...
    return (
        <TooltipProvider>
            <div className="nerv-app-shell">
                <TopRightUserMenu />
                <ShellFrame>
                    <main className={`nerv-content-viewport${pathname === '/dashboard/constellation' || pathname === '/dashboard/scheduler' || pathname?.match(/^\/dashboard\/workflows\/[^/]+\/builder/) ? ' nerv-content-fullbleed' : ''}`}>
                        <ClientShell>
                            <Suspense fallback={
                                <div className="flex items-center justify-center h-full w-full">
                                    <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 12, opacity: 0.5 }}>
                                        <svg width="48" height="48" viewBox="0 0 80 80" fill="none">
                                            ...
                                            <circle cx="40" cy="40" r="34" stroke="oklch(0.78 0.18 55)" strokeWidth="2" strokeLinecap="round" strokeDasharray="50 164" style={{ transformOrigin: '40px 40px', animation: 'nerv-orbit-cw 2.4s linear infinite' }} />
