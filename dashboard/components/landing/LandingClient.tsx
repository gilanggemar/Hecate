...
const CARD_DATA = {
    hero: {
        ...
        description: "A highly optimized, deeply integrated orchestration layer for agent swarms. Build, deploy, and command without friction or limits. NERV.OS orchestrates multiple parallelized agents simultaneously, combining their outputs for complex problem-solving at unprecedented velocity."
    },
    neural: {
        bgText: "NEURAL",
        ...
        description: "Distribute thousands of specialized agents instantly. NERV.OS dynamically allocates ingestion, reasoning, and synthesis tasks across the swarm, dissolving the latency between human intent and machine execution."
    },
    edge: {
        bgText: "EDGE",
    ...
    zero_trust: {
        ...
        description: "Every agent operation is cryptographically signed and executed within sandboxed environments. NERV.OS enforces granular, role-based access controls and end-to-end encryption to ensure uncompromising security."
    },
    ecology: {
        bgText: "EXPAND",
        ...
        description: "Seamlessly connect the swarm to any foundational model, vector database, or external webhook. The NERV.OS SDK and robust REST APIs provide the absolute freedom to forge the exact ecosystem you demand."
    }
}
                ...
                >
                    ...
                    <div className="flex items-center gap-4 z-10">
                        ...
                        <span className="text-2xl font-bold tracking-tight text-[#F5F0EB]">
                            NERV<span className="text-[#FF6D29]">.OS</span>
                        </span>
                    </div>
                                    ...
                                    <div className="max-w-7xl mx-auto flex flex-col lg:flex-row gap-12 lg:gap-24">
                                        ...
                                        <div className="flex-1 flex flex-col justify-center space-y-8">
                                            ...
                                            <p className="text-xl md:text-2xl text-neutral-400 leading-relaxed font-normal">
                                                By leveraging deeply integrated orchestration protocols, NERV.OS ensures that your swarm continually adapts. From dynamic task routing to self-healing node repair, every parameter is optimized for an environment of rapid growth.
                                                <br /><br />
